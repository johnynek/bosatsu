...
object MatchlessGlobalInlining {
        ...
        case head :: tail =>
          head match {
            ...
            case Matchless.Local(_) | Matchless.ClosureSlot(_) |
                ...
                Matchless.Literal(_) | Matchless.LitInt64(_) |
  ...
  private def isKnownArgumentValue[A](expr: Expr[A]): Boolean =
    expr match {
      case Matchless.Literal(_) | Matchless.LitInt64(_) |
          Matchless.MakeEnum(_, 0, _) | Matchless.MakeStruct(0) |
          Matchless.ZeroNat | (_: Matchless.TrueConst.type) =>
        true
