    ...
    val dt = DefinedType[Kind.Arg](
      ...
      constructors = List(
        ConstructorFn[Kind.Arg](
          ...
          args = List(
            ConstructorParam(Identifier.Name("left"), Type.TyVar(a)),
            ConstructorParam(Identifier.Name("right"), Type.TyVar(b)),
            ConstructorParam(Identifier.Name("count"), Type.IntType)
          ),
    ...
    val dt = DefinedType[Kind.Arg](
      ...
      constructors = List(
        ...
        ConstructorFn[Kind.Arg](
          ...
          args = List(ConstructorParam(Identifier.Name("value"), Type.TyVar(a)))
        )
      )
    )
