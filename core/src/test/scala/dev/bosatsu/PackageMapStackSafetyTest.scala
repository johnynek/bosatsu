...
class PackageMapStackSafetyTest extends munit.FunSuite {
  ...
  private val zafuGraph: List[(String, List[String])] = List(
    ...
    (
      "Zafu/Abstract/ApplicativeTests",
      List(
    ...
    (
      "Zafu/Abstract/Monoid",
      List("Zafu/Abstract/Eq", "Zafu/Abstract/Semigroup")
    ),
    ...
    (
      "Zafu/Benchmark/Game/BinaryTreesTests",
      List("Zafu/Benchmark/Game/BinaryTrees")
    ),
    ("Zafu/Benchmark/Game/FannkuchRedux", List("Zafu/Benchmark/Game/Harness")),
    (
      "Zafu/Benchmark/Game/FannkuchReduxTests",
      List("Zafu/Benchmark/Game/FannkuchRedux", "Zafu/Collection/List")
    ),
    (
    ...
    (
      "Zafu/Benchmark/Game/HarnessTests",
      List("Zafu/Control/Result", "Zafu/Benchmark/Game/Harness")
    ),
    (
      "Zafu/Benchmark/Game/Mandelbrot",
      List(
        "Zafu/Benchmark/Game/Harness",
    ...
    (
      "Zafu/Benchmark/Game/Mandelbrot/Internal",
      List("Zafu/Benchmark/Game/Harness")
    ),
    (
      "Zafu/Benchmark/Game/MandelbrotMainTests",
      List("Zafu/Benchmark/Game/Mandelbrot")
    ),
    (
      "Zafu/Benchmark/Game/MandelbrotTests",
      List(
        "Zafu/Control/Result",
        "Zafu/Benchmark/Game/Harness",
        "Zafu/Benchmark/Game/Mandelbrot/Internal"
    ...
    (
      "Zafu/Benchmark/Game/NBody",
      List("Zafu/Control/Result", "Zafu/Benchmark/Game/Harness")
    ),
    (
      "Zafu/Benchmark/Game/SpectralNorm",
      List("Zafu/Control/Result", "Zafu/Benchmark/Game/Harness")
    ),
    ...
    (
      "Zafu/Control/IterStateTests",
      List("Zafu/Control/IterState", "Zafu/Testing/HedgeHog")
    ),
    (
    ...
    (
      "Zafu/Testing/HedgeHog/Range",
      List("Zafu/Testing/HedgeHog/Seed", "Zafu/Testing/HedgeHog/Size")
    ),
  ...
  private def warmResolvePackages(): Unit =
    PackageMap.resolvePackages(
      PackageMap.fromIterable(zafuShapedPackages),
      Nil
    ) match {
      case cats.data.Validated.Valid(_)   => ()
      case cats.data.Validated.Invalid(e) =>
  ...
  Platform.onJvm(
    test(
      "resolvePackages should not stack overflow on a zafu-shaped package DAG"
    ) {
      val stackBytes =
