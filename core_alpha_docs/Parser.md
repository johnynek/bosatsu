...
references: [`Parser`](#type-parser), [`String`](Bosatsu/Predef.md#type-string), [`Unit`](Bosatsu/Predef.md#type-unit)
...
references: [`List`](Bosatsu/Predef.md#type-list), [`Parser`](#type-parser)
...
references: [`Option`](Bosatsu/Predef.md#type-option), [`Parser`](#type-parser), [`String`](Bosatsu/Predef.md#type-string)
