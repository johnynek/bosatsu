...
references: [`Comparison`](../Predef.md#type-comparison), [`Nat`](#type-nat)
...
references: [`Nat`](#type-nat), [`Tuple2`](../Predef.md#type-tuple2)
...
references: [`Bool`](../Predef.md#type-bool), [`Nat`](#type-nat)
...
references: [`Int`](../Predef.md#type-int), [`Nat`](#type-nat)
