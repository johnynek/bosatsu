...
public dependencies: [`Bosatsu/Num/Nat`](Nat.md)
...
references: [`BinNat`](#type-binnat), [`Comparison`](../Predef.md#type-comparison)
...
references: [`BinNat`](#type-binnat), [`Tuple2`](../Predef.md#type-tuple2)
...
references: [`BinNat`](#type-binnat), [`Bool`](../Predef.md#type-bool)
...
references: [`BinNat`](#type-binnat), [`Option`](../Predef.md#type-option)
...
references: [`BinNat`](#type-binnat), [`Int`](../Predef.md#type-int)
...
references: [`BinNat`](#type-binnat), [`Bosatsu/Num/Nat::Nat`](Nat.md#type-nat)
