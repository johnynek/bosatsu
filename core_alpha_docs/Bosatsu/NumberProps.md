...
public dependencies: [`Bosatsu/Num/BinNat`](Num/BinNat.md), [`Bosatsu/Num/Nat`](Num/Nat.md), [`Bosatsu/Rand`](Rand.md)
...
references: [`Bosatsu/Num/BinNat::BinNat`](Num/BinNat.md#type-binnat), [`Bosatsu/Rand::Rand`](Rand.md#type-rand)
...
references: [`Bosatsu/Rand::Rand`](Rand.md#type-rand), [`Int`](Predef.md#type-int)
...
references: [`Bosatsu/Num/Nat::Nat`](Num/Nat.md#type-nat), [`Bosatsu/Rand::Rand`](Rand.md#type-rand)
