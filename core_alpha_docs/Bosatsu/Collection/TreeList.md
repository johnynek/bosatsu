...
references: [`Option`](../Predef.md#type-option), [`TreeList`](#type-treelist), [`Tuple2`](../Predef.md#type-tuple2)
...
references: [`Bool`](../Predef.md#type-bool), [`TreeList`](#type-treelist)
...
references: [`Int`](../Predef.md#type-int), [`Option`](../Predef.md#type-option), [`TreeList`](#type-treelist)
...
references: [`Option`](../Predef.md#type-option), [`TreeList`](#type-treelist)
...
references: [`List`](../Predef.md#type-list), [`TreeList`](#type-treelist)
