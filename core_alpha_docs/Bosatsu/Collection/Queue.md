...
references: [`Bool`](../Predef.md#type-bool), [`Queue`](#type-queue)
...
references: [`List`](../Predef.md#type-list), [`Queue`](#type-queue)
...
references: [`Option`](../Predef.md#type-option), [`Queue`](#type-queue)
...
references: [`Option`](../Predef.md#type-option), [`Queue`](#type-queue), [`Tuple2`](../Predef.md#type-tuple2)
