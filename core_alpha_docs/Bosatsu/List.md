...
public dependencies: [`Bosatsu/Num/Nat`](Num/Nat.md)
...
references: [`Bool`](Predef.md#type-bool), [`List`](Predef.md#type-list)
...
references: [`Int`](Predef.md#type-int), [`List`](Predef.md#type-list), [`Option`](Predef.md#type-option)
...
references: [`List`](Predef.md#type-list), [`Option`](Predef.md#type-option)
...
references: [`Bosatsu/Num/Nat::Nat`](Num/Nat.md#type-nat), [`List`](Predef.md#type-list)
...
references: [`List`](Predef.md#type-list), [`Order`](Predef.md#type-order)
...
references: [`Int`](Predef.md#type-int), [`List`](Predef.md#type-list)
...
references: [`List`](Predef.md#type-list), [`Option`](Predef.md#type-option), [`Tuple2`](Predef.md#type-tuple2)
...
references: [`List`](Predef.md#type-list), [`Tuple2`](Predef.md#type-tuple2)
