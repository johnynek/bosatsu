...
references: [`Bool`](Predef.md#type-bool), [`Rand`](#type-rand)
...
references: [`Int`](Predef.md#type-int), [`Rand`](#type-rand)
...
references: [`Bosatsu/Num/Nat::Nat`](Num/Nat.md#type-nat), [`Rand`](#type-rand)
...
references: [`List`](Predef.md#type-list), [`Rand`](#type-rand)
...
references: [`Rand`](#type-rand), [`Tuple2`](Predef.md#type-tuple2)
