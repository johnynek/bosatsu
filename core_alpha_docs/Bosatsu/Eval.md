...
public dependencies: [`Bosatsu/Lazy`](Lazy.md)
...
references: [`Eval`](#type-eval), [`Unit`](Predef.md#type-unit)
...
references: [`Bool`](Predef.md#type-bool), [`Eval`](#type-eval)
...
references: [`Bosatsu/Lazy::Lazy`](Lazy.md#type-lazy), [`Eval`](#type-eval)
...
references: [`Eval`](#type-eval), [`Int`](Predef.md#type-int)
