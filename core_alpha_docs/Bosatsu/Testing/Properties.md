...
public dependencies: [`Bosatsu/Rand`](../Rand.md)
...
references: [`Bosatsu/Rand::Rand`](../Rand.md#type-rand), [`Prop`](#type-prop), [`String`](../Predef.md#type-string), [`Test`](../Predef.md#type-test)
...
references: [`Int`](../Predef.md#type-int), [`Prop`](#type-prop), [`Test`](../Predef.md#type-test)
...
references: [`List`](../Predef.md#type-list), [`Prop`](#type-prop), [`String`](../Predef.md#type-string)
