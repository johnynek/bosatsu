...
public dependencies: [`Bosatsu/IO/Error`](Error.md), [`Bosatsu/Prog`](../Prog.md)
...
references: [`Bosatsu/IO/Error::IOError`](Error.md#type-ioerror), [`Bosatsu/Prog::Prog`](../Prog.md#type-prog), [`String`](../Predef.md#type-string), [`Unit`](../Predef.md#type-unit)
...
references: [`Bosatsu/IO/Error::IOError`](Error.md#type-ioerror), [`Bosatsu/Prog::Prog`](../Prog.md#type-prog), [`String`](../Predef.md#type-string)
...
references: [`Bosatsu/IO/Error::IOError`](Error.md#type-ioerror), [`Bosatsu/Prog::Prog`](../Prog.md#type-prog), [`Int`](../Predef.md#type-int), [`String`](../Predef.md#type-string)
...
references: [`Bosatsu/IO/Error::IOError`](Error.md#type-ioerror), [`Bosatsu/Prog::Prog`](../Prog.md#type-prog)
