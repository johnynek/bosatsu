...
public dependencies: [`Bosatsu/Collection/Array`](../Collection/Array.md)
...
references: [`Bytes`](#type-bytes), [`List`](../Predef.md#type-list)
...
references: [`Bool`](../Predef.md#type-bool), [`Bytes`](#type-bytes)
...
references: [`Bytes`](#type-bytes), [`Int`](../Predef.md#type-int)
...
references: [`Bosatsu/Collection/Array::Array`](../Collection/Array.md#type-array), [`Bytes`](#type-bytes), [`Int`](../Predef.md#type-int)
...
references: [`Bytes`](#type-bytes), [`Int`](../Predef.md#type-int), [`List`](../Predef.md#type-list)
...
references: [`Bytes`](#type-bytes), [`Int`](../Predef.md#type-int), [`Option`](../Predef.md#type-option)
...
references: [`Bytes`](#type-bytes), [`Int`](../Predef.md#type-int), [`Unit`](../Predef.md#type-unit)
...
references: [`Bool`](../Predef.md#type-bool), [`Bytes`](#type-bytes), [`Int`](../Predef.md#type-int)
...
references: [`Bytes`](#type-bytes), [`Char`](../Predef.md#type-char), [`Int`](../Predef.md#type-int), [`Option`](../Predef.md#type-option)
...
references: [`Bytes`](#type-bytes), [`String`](../Predef.md#type-string)
...
references: [`Bytes`](#type-bytes), [`Option`](../Predef.md#type-option), [`String`](../Predef.md#type-string)
