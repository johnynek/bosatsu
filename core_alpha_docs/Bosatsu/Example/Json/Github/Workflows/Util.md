...
public dependencies: [`Bosatsu/Json`](../../../../Json.md)
...
references: [`List`](../../../../Predef.md#type-list), [`String`](../../../../Predef.md#type-string)
...
references: [`Step`](#type-step), [`String`](../../../../Predef.md#type-string)
...
references: [`FetchJavaWith`](#type-fetchjavawith), [`Step`](#type-step), [`String`](../../../../Predef.md#type-string)
