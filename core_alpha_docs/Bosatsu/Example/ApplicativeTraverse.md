...
references: [`Applicative`](#type-applicative), [`Option`](../Predef.md#type-option)
...
references: [`Applicative`](#type-applicative), [`Tuple2`](../Predef.md#type-tuple2)
...
references: [`List`](../Predef.md#type-list), [`Traverse`](#type-traverse)
