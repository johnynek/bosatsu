...
references: [`Bool`](Predef.md#type-bool), [`Json`](#type-json)
...
references: [`Json`](#type-json), [`Option`](Predef.md#type-option), [`String`](Predef.md#type-string)
...
references: [`Json`](#type-json), [`String`](Predef.md#type-string)
