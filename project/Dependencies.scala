...
object Dependencies {
  ...
  lazy val fs2core = Def.setting("co.fs2" %%% "fs2-core" % "3.12.0")
  lazy val fs2io = Def.setting("co.fs2" %%% "fs2-io" % "3.12.0")
  ...
  lazy val http4sCore = Def.setting("org.http4s" %%% "http4s-core" % "0.23.31")
  lazy val http4sEmber =
    Def.setting("org.http4s" %%% "http4s-ember-client" % "0.23.31")
