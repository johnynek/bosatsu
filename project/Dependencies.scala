...
object Dependencies {
  ...
  lazy val catsEffect = Def.setting("org.typelevel" %%% "cats-effect" % "3.3.13")
  lazy val catsParse = Def.setting("org.typelevel" %%% "cats-parse" % "0.3.7")
  lazy val decline = Def.setting("com.monovore" %%% "decline" % "2.3.0")
  lazy val jawnParser = Def.setting("org.typelevel" %%% "jawn-parser" % "1.3.2")
  lazy val jawnAst = Def.setting("org.typelevel" %%% "jawn-ast" % "1.3.2")
