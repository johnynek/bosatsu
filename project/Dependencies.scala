...
object Dependencies {
  ...
  lazy val catsEffect = Def.setting("org.typelevel" %%% "cats-effect" % "2.5.1")
  lazy val catsParse = Def.setting("org.typelevel" %%% "cats-parse" % "0.3.3")
  ...
  lazy val scalaTest = Def.setting("org.scalatest" %%% "scalatest" % "3.2.8")
