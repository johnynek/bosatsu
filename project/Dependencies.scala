...
object Dependencies {
  lazy val alleycats = Def.setting("org.typelevel" %%% "alleycats-core" % "2.2.0")
  ...
  lazy val munit = Def.setting("org.scalameta" %%% "munit" % "0.7.14")
  lazy val munitScalacheck = Def.setting("org.scalameta" %%% "munit-scalacheck" % "0.7.14")
