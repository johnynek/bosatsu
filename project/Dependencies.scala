...
object Dependencies {
  ...
  lazy val catsEffect = Def.setting("org.typelevel" %%% "cats-effect" % "3.3.1")
  lazy val catsParse = Def.setting("org.typelevel" %%% "cats-parse" % "0.3.6")
  lazy val decline = Def.setting("com.monovore" %%% "decline" % "2.2.0")
  lazy val jawnParser = Def.setting("org.typelevel" %%% "jawn-parser" % "1.3.0")
  lazy val jawnAst = Def.setting("org.typelevel" %%% "jawn-ast" % "1.3.0")
