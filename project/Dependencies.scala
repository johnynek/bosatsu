...
object Dependencies {
  ...
  lazy val munit = Def.setting("org.scalameta" %%% "munit" % "0.7.13")
  lazy val munitScalacheck = Def.setting("org.scalameta" %%% "munit-scalacheck" % "0.7.13")
  ...
  lazy val scalaTest = Def.setting("org.scalatest" %%% "scalatest" % "3.0.9")
}
