...
object Dependencies {
  ...
  lazy val catsEffect = Def.setting("org.typelevel" %%% "cats-effect" % "2.3.0")
  lazy val catsParse = Def.setting("org.typelevel" %%% "cats-parse" % "0.2.0")
  lazy val decline = Def.setting("com.monovore" %%% "decline" % "1.3.0")
  lazy val jawnParser = Def.setting("org.typelevel" %%% "jawn-parser" % "1.0.1")
  lazy val jawnAst = Def.setting("org.typelevel" %%% "jawn-ast" % "1.0.1")
  ...
  lazy val scalaCheck = Def.setting("org.scalacheck" %%% "scalacheck" % "1.15.2")
