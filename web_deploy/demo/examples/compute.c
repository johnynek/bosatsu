...
BValue ___bsts_g_Demo_l_Compute_l_fib(BValue __bsts_b_n0) {
...
BValue __bsts_t_lambda61(BValue __bsts_b_i0, BValue __bsts_b_acc0) {
    return alloc_struct2(___bsts_g_Bosatsu_l_Predef_l_add(bsts_integer_from_int(-1), __bsts_b_i0),
        ___bsts_g_Bosatsu_l_Predef_l_times(__bsts_b_acc0, __bsts_b_i0));
}

BValue ___bsts_g_Demo_l_Compute_l_factorial(BValue __bsts_b_n0) {
...
static BValue ___bsts_c_Demo_l_Compute_l_main() {
    return ___bsts_g_Bosatsu_l_Prog_l_ignore__env(___bsts_g_Bosatsu_l_Prog_l_pure(bsts_integer_from_int(0)));
}

static BValue ___bsts_g_Demo_l_Compute_l_main() {
    return read_or_build(&___bsts_s_Demo_l_Compute_l_main, ___bsts_c_Demo_l_Compute_l_main);
}
...
int main(int argc, char** argv) {
    ...
    init_statics();
    atexit(free_statics);
    BValue main_value = ___bsts_g_Demo_l_Compute_l_main();
