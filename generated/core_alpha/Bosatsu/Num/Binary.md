...
public dependencies: [`Bosatsu/Num/BinNat`](BinNat.html)
...
references: [`BinInt`](#type-binint), [`Bosatsu/Num/BinNat::BinNat`](BinNat.html#type-binnat)
...
references: [`BinInt`](#type-binint), [`Int`](../Predef.html#type-int)
...
references: [`BinInt`](#type-binint), [`Comparison`](../Predef.html#type-comparison)
...
references: [`BinInt`](#type-binint), [`Bool`](../Predef.html#type-bool)
