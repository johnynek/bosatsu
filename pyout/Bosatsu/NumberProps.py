...
nat_props = ___iProperties4.suite_Prop("Nat props",
    (1,
        ___iProperties4.forall_Prop(rand_Nat, "if is_even(n) then times2(div2(n)) == n", ___t7),
        (1,
...
def ___t21(___ba8):
    ...
    if (___a17 == 1) and (___a18 == 1):
        ...
        ___a20 = ___a16[1]
        ___a19 = ___a16[0]
        ___t22 = (___a19 == 0) and (___a20 == 0)
    return (0, ___t22, "cmp vs eq consistency")
def ___t23(___ba9):
    ___bn110 = ___ba9[0]
    ___bn28 = ___ba9[1]
    return (0,
...
binnat_props = ___iProperties4.suite_Prop("BinNat props",
    (1,
        ___iProperties4.forall_Prop(rand_BinNat, "if is_even(n) then times2(div2(n)) == n", ___t15),
        (1,
            ...
            (1,
                ___iProperties4.forall_Prop(rand_BinInt,
                    ...
                    lambda ___bx0: (0,
                        ...
                        "x + (-x) == 0")),
                (1,
                    ___iProperties4.forall_Prop(rand_BinInt, "x + |x| == 0 or 2x", ___t33),
                    (1,
                        ___iProperties4.forall_Prop(rand_BinInt,
                            "x + not(x) == x - x - 1 = -1",
                            ___t34),
