...
last_tests = (1,
    ...
    (1,
        (0, 1, "empty"),
        (1, (0, ___t5, "x"), (1, (0, ___t6, "1234"), (1, (0, ___t7, "👋"), (0,))))))

if "f":
    ___t8 = "foo".partition("f")
    ___a21 = (1, (___t8[0], ___t8[2])) if ___t8[1] else (0,)
else:
    ___a21 = (0,)
if ___a21[0] == 1:
    ___a22 = ___a21[1]
    ___a24 = ___a22[1]
    ___a23 = ___a22[0]
    ___t9 = (___a23 == "") and (___a24 == "oo")
else:
    ___t9 = False
if "":
    ___t10 = "foo".partition("")
    ___a25 = (1, (___t10[0], ___t10[2])) if ___t10[1] else (0,)
else:
    ___a25 = (0,)
if "x":
    ___t11 = "foo".partition("x")
    ___a26 = (1, (___t11[0], ___t11[2])) if ___t11[1] else (0,)
else:
    ___a26 = (0,)
if "o":
    ___t12 = "foo".rpartition("o")
    ___a27 = (1, (___t12[0], ___t12[2])) if ___t12[1] else (0,)
else:
    ___a27 = (0,)
if ___a27[0] == 1:
    ___a28 = ___a27[1]
    ___a30 = ___a28[1]
    ___a29 = ___a28[0]
    ___t13 = (___a29 == "fo") and (___a30 == "")
else:
    ___t13 = False
if "":
    ___t14 = "foo".rpartition("")
    ___a31 = (1, (___t14[0], ___t14[2])) if ___t14[1] else (0,)
else:
    ___a31 = (0,)
if "x":
    ___t15 = "foo".rpartition("x")
    ___a32 = (1, (___t15[0], ___t15[2])) if ___t15[1] else (0,)
else:
    ___a32 = (0,)
partition_tests = (1,
    "partition tests",
    (1,
        (0, ___t9, "foo partition_String f"),
        (1,
            (0, ___a25[0] == 0, "foo partition_String \"\""),
            (1,
                (0, ___a26[0] == 0, "foo partition_String x"),
                (1,
                    (0, ___t13, "foo rpartition_String o"),
                    (1,
