...
def ___h6(___bn14, ___bn24, ___bc0):
    ___a35 = ___bn14
    ___a37 = ___bn24
    ___a39 = ___bc0
    ___a32 = 1
...
def ___h10(___bn7, ___bacc1, ___bis__even0):
    ___a52 = ___bn7
    ___a54 = ___bacc1
...
def times2(___bn1):
    return ___h1(___bn1, 0)

def add(___bn10, ___bn20):
    return ___bn10 if ___bn20 == 0 else ___h3(___bn10, ___bn20)
...
def mult(___bn13, ___bn23):
    return ___h6(___bn23, ___bn13, 0) if cmp_Nat(___bn13, ___bn23) == 2 else ___h6(___bn13,
        ___bn23,
        0)

def is_even(___bn3):
    return ___h8(___bn3, 1)

def div2(___bn6):
    return ___h10(___bn6, 0, is_even(___bn6))

def divmod(___bnumerator0, ___bdivisor0):
    def ___bloop0(___bnumerator1, ___bd0, ___bm1):
        ...
        while ___t12:
            if ___a62 == 0:
                ...
                ___bn9 = ___a58
                ___bm10 = ___a66 + 1
                ___a57 = cmp_Nat(___bm10, ___bdivisor0)
                if ___a57 == 1:
                    ___a61 = ___bn9
                    ___a63 = ___a64 + 1
                    ___a65 = 0
    ...
    if ___bdivisor0 > 0:
        ...
        ___t13 = False
    return (___bnumerator0, 0) if ___t13 else ___bloop0(___bnumerator0,
        0,
...
def exp(___bbase0, ___bpower0):
    if ___bbase0 == 0:
        ...
        if ___t15:
            ...
            def ___bloop1(___bpower1, ___bacc2):
                ___a72 = ___bpower1
                ___a74 = ___bacc2
                ___a69 = 1
                ___t14 = ___a69 == 1
                while ___t14:
                    if ___a72 == 0:
                        ...
                        ___bprev1 = ___a68
                        ___a71 = ___bprev1
                        ___a73 = mult(___a74, ___btwo__or__more0)
                        ___a72 = ___a71
                        ___a74 = ___a73
                    ___t14 = ___a69 == 1
                return ___a70
            return ___bloop1(___bpower0, one)

def to_Int(___bn10):
    return ___h16(0, ___bn10)
...
def to_Nat(___bi0):
    ...
    while ___t19:
        ___t23 = ___t21 + -1
        ___t22 = ___t22 + 1
        ___t19 = (0 < ___t23) and (___t23 < ___t21)
        ___t21 = ___t23
    return ___t22
...
def from_to_law(___bi2, ___bmessage0):
    ...
    while ___t25:
        ...
        ___t27 = ___t29
    return (0, to_Int(___t28) == ___bi2, ___bmessage0)
...
while ___t31:
    ___t35 = ___t33 + -1
    ___t34 = ___t34 + 1
    ___t31 = (0 < ___t35) and (___t35 < ___t33)
    ___t33 = ___t35
___t37 = 0 < -42
___t38 = 0
___t39 = -42
...
while ___t37:
    ___t41 = ___t39 + -1
    ___t40 = ___t40 + 1
    ___t37 = (0 < ___t41) and (___t41 < ___t39)
    ___t39 = ___t41
from_to_suite = (1,
    "to_Nat/to_Int tests",
    (1,
        (0, to_Int(___t34) == 0, "-1 -> 0"),
        (1,
            (0, to_Int(___t40) == 0, "-42 -> 0"),
            (1,
                from_to_law(0, "0"),
                (1,
                    from_to_law(1, "1"),
