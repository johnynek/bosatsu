...
def foldTree(___bt0, ___binit0, ___bfn0):
    ...
    def ___bloop0(___bt1, ___binit1):
        if ___bt1[0] == 0:
            return ___t0[0](___binit1, ___bt1[1])
        else:
            return ___bloop0(___bt1[4], ___bloop0(___bt1[3], ___t0[0](___binit1, ___bt1[2])))
                ...
                if ___t3:
                    ...
                    if ___t2:
                        ...
                        if ___btail0[0] == 1:
                            ___a12 = ___btail0[1]
                            ___a13 = ___btail0[2]
                            ___t1 = (___a12[0] == 1) and (___a13[0] == 0)
                        else:
                            ___t1 = False
                        if ___t1:
    ...
    def ___bloop1(___btrees4, ___binit3):
        ...
        while ___t16:
            if ___a32[0] == 0:
                ...
                ___bt7 = ___a32[2]
                ___a31 = ___bt7
                ___a33 = foldTree(___bh6, ___a34, ___t15[0])
                ___a32 = ___a31
                ___a34 = ___a33
            ___t16 = ___a29 == 1
        return ___a30
...
def eq_TreeList(___bfn2):
    ___t19 = (___bfn2,)
    def ___t18(___ba5, ___bb1):
        ___t21 = (___t19[0],)
        def ___t20(___ba6, ___bh8):
            ...
            if ___bcurrent0 == 1:
                ...
                if ___a36[0] == 0:
                    ...
                    ___a37 = ___a36[1]
                    return (1, ___a37[1]) if ___t21[0](___bh8, ___a37[0]) == 1 else (0, empty)
            else:
                return (0, empty)
        return fold(___ba5, (1, ___bb1), ___t20)[0]
    return ___t18

eq_ti = eq_TreeList(lambda ___t22, ___t23: ___t22 == ___t23)
...
if (___a40[0] == 1) and (___a41[0] == 1):
    ___ba7 = ___a40[1]
    ___bb3 = ___a41[1]
    ___t25 = ___ba7 == ___bb3
else:
    ___a43 = ___a39[1]
    ___a42 = ___a39[0]
    ___t25 = (___a42[0] == 0) and (___a43[0] == 0)
...
if (___a45[0] == 1) and (___a46[0] == 1):
    ___ba8 = ___a45[1]
    ___bb4 = ___a46[1]
    ___t26 = ___ba8 == ___bb4
else:
    ___a48 = ___a44[1]
    ___a47 = ___a44[0]
    ___t26 = (___a47[0] == 0) and (___a48[0] == 0)
___a49 = (get(tl12, 2), (0,))
___a51 = ___a49[1]
___a50 = ___a49[0]
if (___a50[0] == 1) and (___a51[0] == 1):
    ___ba9 = ___a50[1]
    ___bb5 = ___a51[1]
    ___t27 = ___ba9 == ___bb5
else:
    ___a53 = ___a49[1]
    ___a52 = ___a49[0]
    ___t27 = (___a52[0] == 0) and (___a53[0] == 0)
...
if (___a55[0] == 1) and (___a56[0] == 1):
    ___ba10 = ___a55[1]
    ___bb6 = ___a56[1]
    ___t28 = ___ba10 == ___bb6
else:
    ___a58 = ___a54[1]
    ___a57 = ___a54[0]
    ___t28 = (___a57[0] == 0) and (___a58[0] == 0)
...
if (___a60[0] == 1) and (___a61[0] == 1):
    ___ba11 = ___a60[1]
    ___bb7 = ___a61[1]
    ___t29 = ___ba11 == ___bb7
else:
    ___a63 = ___a59[1]
    ___a62 = ___a59[0]
    ___t29 = (___a62[0] == 0) and (___a63[0] == 0)
...
if (___a65[0] == 1) and (___a66[0] == 1):
    ___ba12 = ___a65[1]
    ___bb8 = ___a66[1]
    ___t30 = ___ba12 == ___bb8
else:
    ___a68 = ___a64[1]
    ___a67 = ___a64[0]
    ___t30 = (___a67[0] == 0) and (___a68[0] == 0)
...
if (___a70[0] == 1) and (___a71[0] == 1):
    ___ba13 = ___a70[1]
    ___bb9 = ___a71[1]
    ___t31 = ___ba13 == ___bb9
else:
    ___a73 = ___a69[1]
    ___a72 = ___a69[0]
    ___t31 = (___a72[0] == 0) and (___a73[0] == 0)
tests = (1,
    "TreeList tests",
    (1,
        (0, ___t25, "get 0 == 2"),
        (1,
            ...
            (1,
                (0, ___t27, "get 2 == None"),
                (1,
                    (0, ___t28, "[1, 2, 3, 4] get 0"),
                    (1,
                        (0, ___t29, "[1, 2, 3, 4] get 1"),
                        (1,
                            (0, ___t30, "[1, 2, 3, 4] get 2"),
                            (1,
                                (0, ___t31, "[1, 2, 3, 4] get 3"),
                                (1,
                                    (0,
                                        fold(list14,
                                            0,
                                            lambda ___t32, ___t33: ___t32 + ___t33) == 10,
                                        "fold to 10"),
                                    (1,
                                        (0,
                                            eq_ti(list14, cons14),
