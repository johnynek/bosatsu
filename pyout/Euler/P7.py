...
def int_loop_up(___btop0, ___bres0, ___bfn0):
    ___t1 = (___bfn0, ___btop0)
    def ___t0(___bi0, ___bres1):
        ___a0 = ___t1[0](___t1[1] - ___bi0, ___bres1)
        return (___t1[1] - ___a0[0], ___a0[1])
    ___t2 = 0 < ___btop0
    ___t3 = ___bres0
    ___t4 = ___btop0
    ___t5 = ___bres0
...
def is_prime(___bx0):
    ___t8 = (___bx0,)
    def ___t7(___bi1, ___bdiv0):
        ___bcandidate0 = ___bi1 + 2
        return ((___t8[0], 1) if ___bdiv0 == 1 else (___bi1 + 1,
            (___t8[0] % ___bcandidate0 if ___bcandidate0 else ___t8[0]) == 0)) if (0 if ___bcandidate0 < ___t8[0] else 1 if ___bcandidate0 == ___t8[0] else 2) == 0 else (___t8[0],
            0)
    return ___iBool0.___nnot(int_loop_up(___bx0, 0, ___t7))

def ith_prime(___btotal0):
    ___bmax__size0 = ___iPredef1.range(___btotal0 * ___btotal0)
    ___t10 = (___btotal0,)
    def ___t9(___bprime__cnt0, ___bi2):
        ___bcandidate1 = ___bi2 + 2
        ___bprimes0 = ___bprime__cnt0[0]
        ___bcnt0 = ___bprime__cnt0[1]
        ___a3 = 0 if ___bcnt0 < ___t10[0] else 1 if ___bcnt0 == ___t10[0] else 2
        if ___a3 == 0:
            ___t12 = (___bcandidate1,)
            def ___t11(___bp0):
                return ___iBool0.___nnot((___t12[0] % ___bp0 if ___bp0 else ___t12[0]) == 0)
            return ((1, ___bcandidate1, ___bprimes0),
                ___bcnt0 + 1) if ___iList2.for_all(___bprimes0, ___t11) == 1 else ___bprime__cnt0
        else:
            return ___bprime__cnt0
    ___a4 = ___iPredef1.foldl_List(___bmax__size0, ((0,), 0), ___t9)
    ___bps0 = ___a4[0]
