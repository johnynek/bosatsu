        ...
        def ___t1(___ba4, ___bal0):
            ...
            if ___bg0 == 1:
                ...
                if ___a7[0] == 0:
                    ...
                    ___a8 = ___a7[1]
                    return (___t2[0](___bal0, ___a8[0]), ___a8[1])
            else:
                return (0, empty_Queue)
        ___t4 = (___beq__fn0,)
        def ___t3(___ba5, ___bal1):
            ___bg1 = ___ba5[0]
            ___bright3 = ___ba5[1]
            if ___bg1 == 1:
                ...
                if ___a9[0] == 0:
                    ...
                    ___a10 = ___a9[1]
                    return (___t4[0](___bal1, ___a10[0]), ___a10[1])
            else:
                return (0, empty_Queue)
        ___a11 = ___iPredef0.foldl_List(___iPredef0.reverse(___bb5),
            ___iPredef0.foldl_List(___bf3, ___binit1, ___t1),
            ___t3)
        ___a13 = ___a11[1]
        ___a12 = ___a11[0]
        if ___a12 == 1:
            ___a15 = ___a13[1]
            ___a14 = ___a13[0]
            ___t5 = (___a14[0] == 0) and (___a15[0] == 0)
        else:
            ___t5 = False
        return ___t5
    return ___t0
...
eq_qi = eq_Queue(lambda ___t6, ___t7: ___t6 == ___t7)

eq_li = ___iList1.eq_List(lambda ___t8, ___t9: ___t8 == ___t9)
...
def rand_Queue_depth(___bdepth0):
    if ___bdepth0 == 0:
        ...
        return ___iRand2.one_of(___bpop__rand0,
            (1,
                ___iRand2.map_Rand(___iRand2.prod_Rand(rand_int, ___bsmaller0), ___t11),
    ...
    def ___binner0(___blst1):
        if ___blst1[0] == 0:
            ...
            if ___blst1[0] == 1:
                ...
                ___t14 = False
            if ___t14:
                return ___bshowa0(___blst1[1])
            else:
                ___ba9 = ___blst1[1]
                ___bt2 = ___blst1[2]
                ___t12 = []
                ___t13 = (1, ___bshowa0(___ba9), (1, ", ", (1, ___binner0(___bt2), (0,))))
                while ___t13[0] != 0:
                    ___t12.append(___t13[1])
                    ___t13 = ___t13[2]
                return "".join(___t12)
    ___t15 = []
    ___t16 = (1, "[", (1, ___binner0(___blst0), (1, "]", (0,))))
    while ___t16[0] != 0:
...
def ___t19(___bq2):
    ...
    if ___a23[0] == 0:
        ...
        if ___a22[0] == 1:
            ___bh3 = ___a22[1]
            ___t20 = ___bh3 == ___bi0
        else:
            ___t20 = 0
    return (0, ___t20, "check head")
def ___t21(___bq3):
    ...
    ___t26 = (1,
        "rev_tl = ",
        (1,
            show_List(___brev__tl0, lambda ___t22: ___t22.__str__()),
            (1,
                " tl_rev = ",
                (1,
                    show_List(___btl__rev0, lambda ___t23: ___t23.__str__()),
                    (1, ": ", (1, show_Queue(___bq3, lambda ___t24: ___t24.__str__()), (0,)))))))
    while ___t26[0] != 0:
        ___t25.append(___t26[1])
        ___t26 = ___t26[2]
    return (0, eq_li(___brev__tl0, ___btl__rev0), "".join(___t25))
def ___t27(___ba11):
    ___bh4 = ___ba11[0]
    ___bq4 = ___ba11[1]
    ___bf11 = ___bq4[0]
...
queue_laws = ___iProperties4.suite_Prop("queue properties",
    (1,
        ___iProperties4.forall_Prop(rand_Queue_Int, "pop-law/toList", ___t19),
        (1,
            ___iProperties4.forall_Prop(rand_Queue_Int, "reverse isomorphism", ___t21),
            (1,
                ___iProperties4.forall_Prop(___iRand2.prod_Rand(rand_int, rand_Queue_Int),
                    "push is the same as reverse prepend reverse",
                    ___t27),
                (1,
                    ___iProperties4.forall_Prop(rand_Queue_Int, "pop isomorphism", ___t28),
                    (0,))))))
...
if (___a32[0] == 1) and (___a33[0] == 1):
    ___ba13 = ___a32[1]
    ___bb19 = ___a33[1]
    ___t30 = ___ba13 == ___bb19
else:
    ___a35 = ___a31[1]
    ___a34 = ___a31[0]
    ___t30 = (___a34[0] == 0) and (___a35[0] == 0)
___bf17 = q12[0]
___bb20 = q12[1]
___bf18 = q12[0]
___bb21 = q12[1]
        ...
        (1,
            (0,
                ___iPredef0.foldl_List(___iPredef0.reverse(___bb20),
                    ___iPredef0.foldl_List(___bf17, 0, lambda ___t31, ___t32: ___t31 + ___t32),
                    lambda ___t33, ___t34: ___t33 + ___t34) == 3,
                "fold_Queue add"),
            (1,
                (0,
